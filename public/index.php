...
$rotasPublicas = ['/login', '/logout', '/selecionar-empresa', '/test.php', '/api/orthanc/ping', '/open/', '/api/viewer/measurements', '/api/sla-regras/executar', '/api/servidor-pacs/sync-robo'];
