...
$rotasPublicas = ['/login', '/logout', '/selecionar-empresa', '/test.php', '/api/orthanc/ping', '/open/', '/internal/viewer-auth/', '/api/viewer/measurements', '/api/sla-regras/executar', '/api/servidor-pacs/sync-robo', '/api/report-delivery/', '/desktop-launch/'];
