...
foreach ([
    ...
    [$artifact, 'ReportPdfDeliveryContextService($this->pdo)', 'contexto visual no artifact'],
    [$artifact, 'renderSnapshotBinary($visualContext)', 'renderização snapshot non-DICOM'],
