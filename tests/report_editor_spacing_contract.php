...
$input = '<p class="ql-spacing-medium ql-align-justify unsafe-class" style="margin-bottom:999px">Linha A</p>'
    . '<p class="ql-spacing-wide">Linha B</p>';
$output = ReportClinicalHtmlSanitizer::sanitize($input);

$expected = '<p class="ql-spacing-medium ql-align-justify">Linha A</p><p class="ql-spacing-wide">Linha B</p>';
if ($output !== $expected) {
