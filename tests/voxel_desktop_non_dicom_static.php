...
if (!str_contains($repository, "SqlHelper::hasTable(\$this->pdo, 'pacs_voxel_desktop_manual_tests')")) throw new RuntimeException('Leitura de testes manuais deve informar PDO ao helper de schema.');
