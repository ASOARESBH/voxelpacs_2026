...
Router::get('/unidades/{id}/template-personalizado', 'ReportCustomTemplateController@editorInstitution');
Router::post('/unidades/{id}/template-personalizado/salvar', 'ReportCustomTemplateController@saveInstitution');
Router::post('/unidades/{id}/template-personalizado/publicar', 'ReportCustomTemplateController@publishInstitution');
Router::post('/unidades/{id}/template-personalizado/preview', 'ReportCustomTemplateController@previewInstitution');
...
Router::get('/unidades/{id}/editar/template-personalizado', 'ReportCustomTemplateController@editorUnidade');
Router::post('/unidades/{id}/editar/template-personalizado/salvar', 'ReportCustomTemplateController@saveUnidade');
Router::post('/unidades/{id}/editar/template-personalizado/publicar', 'ReportCustomTemplateController@publishUnidade');
Router::post('/unidades/{id}/editar/template-personalizado/preview', 'ReportCustomTemplateController@previewUnidade');
